...
import com.deepoove.poi.policy.CustomTableListRenderPolicy;
...
import com.deepoove.poi.policy.PictureListRenderPolicy;
...
public class Configure implements Cloneable {
  ...
  Configure() {
    ...
    plugin(GramerSymbol.CUSTOMTABLE, new CustomTableRenderPolicy());
    plugin(GramerSymbol.CUSTOMTABLELIST, new CustomTableListRenderPolicy());
    plugin(GramerSymbol.PICTURELIST, new PictureListRenderPolicy());
  }
